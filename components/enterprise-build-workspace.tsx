...
import { LiveAgentChat } from './live-agent-chat';
  ...
  return (
    <div className="space-y-3 bg-[#F6F0E1] p-3 text-[#101114]">
      <div className="rounded-2xl border border-[#C8A24D] bg-[#071326] p-3 text-[#F5F7FA]">
        ...
        <p className="text-sm text-[#D7D9DE]">Governed AI chat, commands, planning, approval controls, pull request evidence, and application preview in one customer workspace.</p>
      </div>
      <LiveAgentChat />
      <AgentCommandCenter />
