    ...
    <div className="space-y-8">
      <section className="rounded-3xl border border-slate-800 bg-slate-900 p-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.22em] text-indigo-300">Prompt to PRD to Plan to Handoff</p>
            <h2 className="mt-2 text-2xl font-black text-slate-100">Generate a governed builder handoff</h2>
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-400">
              Drafts PRD, derives plan, runs observer, and creates a hash-bound runtime handoff envelope. It still does not execute.
            </p>
          </div>
