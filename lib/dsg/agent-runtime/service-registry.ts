...
export function listAgentRuntimeServices(): AgentRuntimeService[] {
  ...
  return [
    ...
    },
    {
      ...
      description: 'Verifies deployment evidence for the configured URL. A deploy action is eligible only after gate_allow + evidence + no mock_state.',
      status: 'approval_required',
      implementation: 'server_tool_call',
      action: 'POST /api/dsg/agents/deploy-monitor with deploymentUrl and gateAllow after the approved deployment handoff.',
